                ...
                >
                  ...
                  >
                    <td
                      ...
                      bgcolor="#71b6f9"
                      valign="top"
                    >Warning: You're approaching your limit. Please upgrade.</td>
                  </tr>
                  <tr
                    style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;"
                  >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <span
                                style="background-color: #ec4561;color: #ffffff;padding: 5px 8px; font-size: 12px; border-radius: 4px"
                              >
                                1
                                free report
                              </span>
                        ...
                        >
                          <td
                            ...
                            style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                            valign="top"
                          >Add your credit card now to upgrade your account to a premium plan to ensure you don't miss out on any reports.</td>
                        </tr>
                        <tr
                          style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;"
                        >
                        ...
                        >
                          <td
                            ...
                            valign="top"
                          >© {{new Date().getFullYear()}} Veltrix</td>
                        </tr>
                      </table>
                    </td>
                  </tr>
