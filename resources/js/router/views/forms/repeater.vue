        ...
        <div class="card">
          <div class="card-body">
            ...
            <form class="repeater" enctype="multipart/form-data">
              <div data-repeater-list="group-a">
                <div v-for="(field, index) in fields" :key="field.id" class="row">
                  ...
                  <div class="form-group col-lg-2">
                    ...
                    <input type="email" v-model="field.email" id="email" class="form-control" />
                  </div>

                  <div class="form-group col-lg-2">
                    <label for="subject">Subject</label>
                    <input type="text" v-model="field.subject" id="subject" class="form-control" />
                  </div>
              ...
              <input type="button" class="btn btn-success mo-mt-2" value="Add" @click="AddformData" />
            </form>
          </div>
        </div>
      </div>
